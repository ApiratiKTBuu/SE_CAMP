          ...
          <div class="row">
            ...
            <div class="col-lg-12">
              ...
              <div class="card card-primary">
                ...
                <!-- /.card-header -->
                <!-- form start -->
                <form action="/titles<?php if(isset($title_id)) { echo '/'. $title_id->tit_id;}?>" method="post">
                  ...
                  <div class="card-body">
                    <div class="form-group">
                      ...
                      value="<?php
                            ...
                            ?>"
                            class="form-control" id="exampleInputEmail1" placeholder="เช่น นาย นาง นางสาว ฯลฯ">
                    </div>
                    <div class="form-check">
                      <input type="checkbox" name="tit_is_active"
                      <?php
                            if(isset($title_id) && $title_id->tit_is_active == 1){?>checked
                            <?php }?>
